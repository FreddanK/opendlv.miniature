/**
 * proxy-irdetection - Interface to irdetection.
 ...
 */
class ProxyTestling : public IRDetection {
   private:
    ProxyTestling();

   public:
    ProxyTestling(const int32_t &argc, char **argv)
        : IRDetection(argc, argv) {}

    // Here, you need to add all methods which are protected in IRDetection and which are needed for the test cases.
};
...
class PwmTest : public CxxTest::TestSuite {
 ...
 public:
  void setUp() {
    ...
    string argv0("proxy-irdetection");
